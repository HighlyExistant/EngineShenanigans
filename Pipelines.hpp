...
namespace cow 
{
	...
	GraphicsPipeline::GraphicsPipeline(Device& device, GraphicsPipelineSimpleInfo *pCreateInfo)
		: m_ref_device{ device }
	{
		...
		*/
		auto bindDesc = Vertex2DSRGB::bindingDescription();
		auto attrDesc = Vertex2DSRGB::attributeDescriptions();
